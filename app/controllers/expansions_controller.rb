class ExpansionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @expansion.update(expansion_params)
        format.html { redirect_to @expansion, notice: "Expansion was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to expansions_path, notice: "Expansion was successfully destroyed.", status: :see_other }
