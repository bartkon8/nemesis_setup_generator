...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { expansion_id: @variant.expansion_id, game_id: @variant.game_id, name: @variant.name, priority: @variant.priority } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { expansion_id: @variant.expansion_id, game_id: @variant.game_id, name: @variant.name, priority: @variant.priority } }
